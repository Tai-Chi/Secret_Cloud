...
describe 'Testing file/folder resource routes' do
  ...
  before do
    ...
    CreateGaccount.call(name: 'secret.cloud.0001', account_id: Account.where(name: 'Dennis Hsieh').first.id)
    CreateGaccount.call(name: 'secret.cloud.0002', account_id: Account.where(name: 'Dennis Hsieh').first.id)
    CreateGaccount.call(name: 'secret.cloud.0003', account_id: Account.where(name: 'Joey Hong').first.id)
    CreateGaccount.call(name: 'secret.cloud.0004', account_id: Account.where(name: 'Joey Hong').first.id)
    CreateGaccount.call(name: 'secret.cloud.0005', account_id: Account.where(name: 'Alan Tsai').first.id)
    CreateGaccount.call(name: 'secret.cloud.0006', account_id: Account.where(name: 'Alan Tsai').first.id)
    CreateGaccount.call(name: 'secret.cloud.0007', account_id: Account.where(name: 'Guest').first.id)
    CreateGaccount.call(name: 'secret.cloud.0008', account_id: Account.where(name: 'Guest').first.id)
